...
namespace LiteVehicles
{
    public class WorkGiver_RepairVehicle : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing thing, bool forced = false)
        {
            ...
            bool flag = vehicle != null && vehicle.def.HasComp(typeof(Comp_Vehicle)) && vehicle.GetComp<Comp_Vehicle>().repairToggle && HasRepairableDamage(vehicle);
            if (flag)
            {
        ...
        public static Thing FindRepairParts(Pawn pawn, Pawn vehicle, bool forced)
        {
            ...
            Map map = vehicle.Map;
            ThingDef repairItem = vehicle.GetComp<Comp_Vehicle>().Props.repairItem;
            if(repairItem == null)
            {
