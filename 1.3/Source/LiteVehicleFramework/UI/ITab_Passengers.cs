...
namespace LiteVehicles
{
    public class ITab_Passengers2 : ITab
    {
        ...
        private Comp_Vehicle CompPilot
        {
            get
            {
                Comp_Vehicle result = null;
                if (SelPawn != null)
                {
                    var compPilotable = SelPawn.GetComp<Comp_Vehicle>();
        ...
        public void DoColumnHeaders(ref float curY)
        {
            if (!compactMode)
            {
                var num = 135f;
        ...
        public void DoRows(ref float curY, Rect scrollViewRect, Rect scrollOutRect)
        {
            var pawns = Pawns;
        ...
        public Vector2 GetRawSize(bool compactMode)
        {
            var num = 100f;
            if (!compactMode)
            {
        ...
        public void DoRow(ref float curY, Rect viewRect, Rect scrollOutRect, Pawn p)
        {
        ...
        public void DoRow(Rect rect, Pawn p)
        {
            GUI.BeginGroup(rect);
        ...
        public void DoPain(Rect rect, Pawn pawn)
        {
        ...
        public void DoCapacity(Rect rect, Pawn pawn, PawnCapacityDef capacity)
        {
